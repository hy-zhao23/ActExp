...
CONFIG="experiments/training/configs/data_scale/v0-10_500k_diverse_fullqa.yaml"
STAGE1_CKPT="checkpoints/data_scale/oracle_act_v0-10_500k_diverse/final"
...
echo "[s2_v0-10] nodes=${SLURM_JOB_NODELIST}  master=${MASTER_ADDR}:${MASTER_PORT}"
