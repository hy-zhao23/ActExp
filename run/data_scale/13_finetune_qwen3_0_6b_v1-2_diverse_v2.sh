...
# Qwen3-0.6B v2 ft: dep on act v2 (1035501+offset).
# Loads fresh stage-1 ckpt trained with 4B-aligned hp.
...
STAGE1_CKPT="checkpoints/oracle_act_qwen3_0_6b_v1-2_diverse_v2/final"
