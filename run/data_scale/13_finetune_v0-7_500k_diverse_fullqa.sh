#!/bin/bash
#SBATCH --job-name=ds_ft_v0-7_500k_diverse_fullqa
...
CONFIG="experiments/training/configs/data_scale/v0-7_500k_diverse_fullqa.yaml"
STAGE1_CKPT="checkpoints/data_scale/oracle_act_v0-7_500k_diverse/final"   # 共享自 v1-2_500k_diverse
...
echo "[ds_ft_v0-7_500k_diverse_fullqa] nodes=${SLURM_JOB_NODELIST}  master=${MASTER_ADDR}:${MASTER_PORT}"
...
echo "[ds_ft_v0-7_500k_diverse_fullqa] done"
