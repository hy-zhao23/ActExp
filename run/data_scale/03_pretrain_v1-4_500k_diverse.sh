#!/bin/bash
#SBATCH --job-name=ds_act_v1-4_500k_diverse
...
echo "[ds_act_v1-4_500k_diverse] nodes=${SLURM_JOB_NODELIST}  master=${MASTER_ADDR}:${MASTER_PORT}"
...
echo "[ds_act_v1-4_500k_diverse] done"
