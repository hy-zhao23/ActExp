...
读 out/eval/rebuttal_r2_qatypes/scores.jsonl（eval_score.py 产物），
...
SCORES = Path("out/eval/rebuttal_r2_qatypes/scores.jsonl")
VARIANTS = ["r2_gistcls", "r2_factonly", "r2_mix500k"]
